...
namespace Transition
{
    public class Transition
    {
        ...
        public virtual void GetRandomStaticTiles(ushort X, ushort Y, ushort Z, Collection[,] StaticMap, bool iRandom)
        {
            if (this.m_StaticTiles.Count > 0)
            {
                StaticTile randomTile = this.m_StaticTiles.RandomTile;
                StaticMap[(int)((ushort)(X >> 3)), (int)((ushort)(Y >> 3))].Add(new StaticCell(randomTile.TileID, checked((byte)(X % 8)), checked((byte)(Y % 8)), (ushort)(Z + randomTile.AltIDMod)), null, null, null);
            }
            if (iRandom)
            {
        ...
        public void AddMapTile(ushort TileID, ushort AltIDMod)
        {
        ...
        public void AddStaticTile(ushort TileID, ushort AltIDMod)
        {
