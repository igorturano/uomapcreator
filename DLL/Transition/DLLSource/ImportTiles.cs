            ...
            try
            {
                ...
                try
                {
                    while (enumerator.MoveNext())
                    {
                        ...
                        ushort iTileID = (ushort)XmlConvert.ToInt16(xmlElement2.GetAttribute("TileID"));
                        ushort num = (ushort)XmlConvert.ToInt16(xmlElement2.GetAttribute("X"));
                        ushort num2 = (ushort)XmlConvert.ToInt16(xmlElement2.GetAttribute("Y"));
                        ushort iZ = (ushort)XmlConvert.ToInt16(xmlElement2.GetAttribute("Z"));
                        ushort iHue = (ushort)XmlConvert.ToInt16(xmlElement2.GetAttribute("Hue"));
                        StaticCell item = checked(new StaticCell(iTileID, (byte)(num % 8), (byte)(num2 % 8), iZ, iHue));
                        StaticMap[(int)((ushort)(num >> 3)), (int)((ushort)(num2 >> 3))].Add(item, null, null, null);
                    }
                }
                finally
                {
